from modules.timesformer import TimeSFormerClassifier
import torch
import os 
import pandas as pd
...
def main():
    ...
    checkpoint_path = "models/TimeSFormer/Pretrain-2/9.pth"
    dataset_folder = "dataset_1"
    dataset_json = "dataset.json"

    wdb_name = "T-Pretraining-3"
    wdb_notes = "Freezed, Using Batches, Shuffle, Learning Rate lowered"
    ...
    model = TimeSFormerClassifier("facebook/timesformer-base-finetuned-k400", num_classes=13)
