from modules.timesformer import TimeSFormerClassifierT2
import torch
import os 
import pandas as pd
...
def main():
    ...
    checkpoint_path = "models/TimeSFormer/PredictorB-Exp-2/B_20.pth"
    dataset_folder = "dataset_2"
    dataset_json = "dataset.json"

    wdb_name = "T-PredictorB-Exp-3"
    wdb_notes = "Dataset increased."
    ...
    model = TimeSFormerClassifierT2("facebook/timesformer-base-finetuned-k400", num_classes=13)
